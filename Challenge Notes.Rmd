...
```{r v<- c("Stately,","plump","Buck","Mulligan","came","from","the","stairhead,","bearing","a","bowl","of","lather","on","which","a","mirror","and","a","razor","lay","crossed")
...
df[ ,3] <- as.factor(df[ ,3])
 str(df)
#I was messed up before because I was trying to do str(q), which is what I named the matrix, but I renamed it df after I set it up as a data frame
